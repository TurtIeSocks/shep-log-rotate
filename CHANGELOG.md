...
## [0.1.0-alpha.2](https://github.com/TurtIeSocks/shep-log-rotate/compare/v0.1.0-alpha.1...v0.1.0-alpha.2) - 2026-08-26

### Other

- that error string needed a fenced block, not an inline span
- the install command I just wrote does not work

## [0.1.0-alpha.1](https://github.com/TurtIeSocks/shep-log-rotate/releases/tag/v0.1.0-alpha.1) - 2026-08-26
